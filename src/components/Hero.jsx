  ...
  return (
    ...
    >
      ...
      <h1 className="text-4xl sm:text-5xl md:text-6xl xl:text-[84px] font-medium xl:leading-[95px] max-w-5xl">
        ...
        <span className="bg-gradient-to-r from-[#5044E5] to-[#4dBcea] bg-clip-text text-transparent">
          digital
        </span>{" "}
        impact.
      </h1>
      ...
      <div className="relative">
        ...
        <img className="absolute -top-60 -right-40 sm:-top-100 sm:-right-70 -z-1 dark:hidden" src={assets.bgImage1} alt="" />
      </div>
    </div>
  );
};
